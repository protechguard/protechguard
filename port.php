    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="port.php" class="nav-item nav-link active"><i class="fas fa-network-wired me-2"></i>PortShield</a>
        ...
        <div class="content">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h3 class="mb-4">PortShield</h3>
                            <form action="http://localhost/utils/port_scan.php" method="post">
                                <div class="mb-3">
                                    ...
                                    <div id="domainHelp" class="form-text">Scan your system to identify open ports.
                                    </div>
                                </div>
            ...
            if (isset($_GET["domain"])){
                $domain = $_GET["domain"];
                $download_url = "http://localhost/utils/port$domain.txt";
                $domain = $_GET["domain"];
                $results = file_get_contents("./utils/port$domain.txt");
                $results = explode("\n", $results);
            }
            else{
                $results = NULL;
            ...
            <div class="col-sm-12 col-xl-12 mt-2">
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="row">
                            <div class="col-md-11">
                            <h6 class="mb-4">Open Port Results</h6>
                            </div>
