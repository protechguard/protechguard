    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="subdomain.php" class="nav-item nav-link active"><i class="fas fa-binoculars me-0"></i>Subdomain Hunter</a>
        ...
        <div class="content">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h3 class="mb-4">Subdomain Hunter</h3>
                            <form action="http://localhost/utils/subdomain_scan.php" method="post">
                                <div class="mb-3">
                                    ...
                                    <div id="domainHelp" class="form-text">Please specify the domain for which you want to find the subdomains.
                                    </div>
                                </div>
            ...
            if (isset($_GET["domain"])){
                $domain = $_GET["domain"];
                $download_url = "http://localhost/utils/sub$domain.txt";
                $domain = $_GET["domain"];
                $results = file_get_contents("./utils/sub$domain.txt");
                $results = explode("\n", $results);
            ...
            <div class="col-sm-12 col-xl-12 mt-2">
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="row">
                            <div class="col-md-11">
                            <h6 class="mb-4">Subdomain Results</h6>
                            </div>
